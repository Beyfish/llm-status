...
const zhCN = {
  translation: {
    ...
    detail: { models: '可用模型', credentials: '凭证管理', modelName: '模型名称', price: '价格', capabilities: '能力', status: '状态', provider: '提供商', copyCurl: '📋 复制 curl', clipboardAutoClear: '✅ {{seconds}}s' },
...
const enUS = {
  translation: {
    ...
    detail: { models: 'Available Models', credentials: 'Credentials', modelName: 'Model', price: 'Price', capabilities: 'Capabilities', status: 'Status', provider: 'Provider', copyCurl: '📋 Copy curl', clipboardAutoClear: '✅ {{seconds}}s' },
