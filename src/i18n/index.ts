...
const zhCN = {
  translation: {
    ...
    settings: { title: '设置', general: '通用', detection: '检测', appearance: '外观', advanced: '高级', language: '语言', storageMode: '存储方式', encrypted: '加密存储', plaintext: '明文存储', defaultMode: '默认检测模式', autoCheck: '自动检测间隔', off: '关闭', minutes: '分钟', hour: '小时', theme: '主题', configPath: '配置文件路径', configPathUnavailable: '当前运行环境未挂载桌面桥接，无法读取配置文件路径' },
    ...
    credentialBackup: {
      ...
      unavailableExport: '当前运行环境未挂载桌面桥接，无法导出凭证',
      unavailableImport: '当前运行环境未挂载桌面桥接，无法导入凭证',
      exportFailed: '导出失败',
      importFailed: '导入失败',
